...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: <explanation>ItemGroup is a non-semantic wrapper for grouping items, so using a div here is acceptable for semantic purposes.</explanation>
    <div
