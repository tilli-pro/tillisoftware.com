...
export const Header: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="page-width z-10 flex h-full items-center gap-4 px-8 py-2">
        <div className="z-9999 w-16 flex-1 font-header font-medium text-2xl tracking-normal md:flex-0">
          tilli
        </div>
        ...
        <div className="z-9999 hidden w-16 items-center gap-4 text-xs md:flex">
